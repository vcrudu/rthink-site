    ...
    <div className="flex flex-col">
      <div className="flex flex-col items-center md:items-start md:flex-row mt-36 md:justify-stretch">
        <div className="mb-5 md:mt-0">
          ...
          <div className="text-[20px] font-bold ml-10 text-orange-700 mt-12 md:mt-6">
            Here we describe the priciples we use to develop AI sollutions.
          </div>
        </div>
      ...
      <div className="flex flex-col mt-8 m-5 text-lg justify-center items-center">
        <p className="w-screen md:w-7/12 ">
          ...
          only ensures that our solutions are at the forefront of AI
          advancements but also significantly reduces the overall cost of
          projects. Our goal is to deliver top-tier AI solutions that are both
